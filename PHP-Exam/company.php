		...
		<div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="company.php"> Company</a>
                    </li>
					<li>
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Walbro - Company <br>
							<small>Manage company for Walbro.</small><br>
		                </h1>	
		  </div>
            <div id="page-inner">
                                ...
                                <table class="table">
                                    <thead>
									    <tr>
										   ...
										   <td><input type="type" class="form-control" id="logo">
										   </td>
										   <td><input type="type" class="form-control" id="name"></td>
                                    ...
                                    <tbody>
									    ...
									    curl_setopt($ch, CURLOPT_URL, "http://localhost/php-exam/api.php?view=company");
										curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
										$response = curl_exec($ch);
     ...
     <script src="assets/js/jquery.js"></script>
      <script>
         $(document).ready(function(){
			  ...
			  $("#add").click(function(){
				   if ($("#logo").val() == "" || $("#name").val() == "" || $("#status").val() == "") {
